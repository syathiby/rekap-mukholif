...
<div class="sb-nav">
    ...
    <?php if (App\Helpers\AuthHelper::hasPermission(['pelanggaran_bahasa_input', 'pelanggaran_diniyyah_input', 'pelanggaran_kesantrian_input', 'pelanggaran_pengabdian_input', 'pelanggaran_tahfidz_input'])): ?>
    ...
    <?php if (App\Helpers\AuthHelper::hasPermission(['jenis_reward_view', 'reward_input', 'reward_history'])): ?>
    ...
    <?php if (App\Helpers\AuthHelper::hasPermission('eksekusi_manage')): ?>
    ...
    <?php if (App\Helpers\AuthHelper::hasPermission(['rapot_view', 'rapot_create', 'rapot_cetak', 'rapot_delete'])): ?>
    ...
    <?php if (App\Helpers\AuthHelper::hasPermission(['rekap_pelanggaran_umum', 'rekap_detail_santri', 'rekap_kebersihan', 'rekap_keterlambatan', 'rekap_santri_teladan', 'rekap_kamar', 'rekap_view_statistik', 'rekap_view_tahfidz'])): ?>
    ...
    <?php if (App\Helpers\AuthHelper::hasPermission(['santri_view', 'jenis_pelanggaran_view', 'jenis_pelanggaran_create', 'jenis_pelanggaran_edit', 'jenis_pelanggaran_delete', 'jenis_reward_view', 'jenis_reward_create', 'jenis_reward_edit', 'jenis_reward_delete'])): ?>
    <div class="sb-section-label">MANAJEMEN</div>
    <?php endif; ?>
    
    <?php if (App\Helpers\AuthHelper::hasPermission('santri_view')): ?>
    ...
    <?php if (App\Helpers\AuthHelper::hasPermission(['jenis_pelanggaran_view', 'jenis_pelanggaran_create', 'jenis_pelanggaran_edit', 'jenis_pelanggaran_delete'])): ?>
    ...
    <?php if (App\Helpers\AuthHelper::hasPermission(['jenis_reward_view', 'jenis_reward_create', 'jenis_reward_edit', 'jenis_reward_delete'])): ?>
    ...
    <?php if (App\Helpers\AuthHelper::hasPermission(['arsip_view', 'arsip_create', 'arsip_delete', 'export_laporan', 'user_manage', 'periode_aktif_manage', 'reset_poin_manage', 'izin_manage', 'history_manage', 'backup_restore_manage', 'activity_log_manage', 'impor_data'])): ?>
    <div class="sb-section-label">SISTEM</div>
    <?php endif; ?>

    <?php if (App\Helpers\AuthHelper::hasPermission(['arsip_view', 'arsip_create', 'arsip_delete'])): ?>
    ...
    <?php if (App\Helpers\AuthHelper::hasPermission('export_laporan')): ?>
    ...
    <?php if (App\Helpers\AuthHelper::hasPermission(['user_manage', 'periode_aktif_manage', 'reset_poin_manage', 'izin_manage', 'history_manage', 'backup_restore_manage', 'activity_log_manage', 'impor_data'])): ?>
