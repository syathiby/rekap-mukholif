...
<ul class="nav flex-column">
    ...
    <li class="nav-item">
        <a class="nav-link apply-color-hover-active color-blue <?= strpos($current_uri, 'index.php') !== false ? 'active' : '' ?>" href="/rekap-mukholif/index.php">
    ...
    <li class="nav-item">
        <a class="nav-link apply-color-hover-active color-green <?= strpos($current_uri, 'santri') !== false ? 'active' : '' ?>" href="/rekap-mukholif/santri/">
    ...
    <li class="nav-item">
        <a class="nav-link apply-color-hover-active color-indigo <?= strpos($current_uri, 'pelanggaran') !== false ? 'active' : '' ?>" href="/rekap-mukholif/pelanggaran/">
    ...
    <li class="nav-item">
        <a class="nav-link apply-color-hover-active color-teal <?= strpos($current_uri, 'eksekusi') !== false ? 'active' : '' ?>" href="/rekap-mukholif/eksekusi/">
    ...
    <li class="nav-item">
        <a class="nav-link apply-color-hover-active color-purple <?= strpos($current_uri, 'arsip') !== false ? 'active' : '' ?>" href="/rekap-mukholif/arsip/">
    ...
    <li class="nav-item">
        <a class="nav-link apply-color-hover-active color-red <?= strpos($current_uri, 'rekap') !== false ? 'active' : '' ?>" href="/rekap-mukholif/rekap/">
    ...
    <li class="nav-item">
        <a class="nav-link apply-color-hover-active color-cyan <?= strpos($current_uri, 'export') !== false ? 'active' : '' ?>" href="/rekap-mukholif/export/">
    ...
    <!-- Menu Pengaturan -->
    <?php if (has_permission(['user_manage', 'periode_aktif_manage', 'reset_poin_manage', 'izin_manage'])): ?>
    <li class="nav-item">
        <a class="nav-link apply-color-hover-active color-gray <?= strpos($current_uri, 'pengaturan') !== false ? 'active' : '' ?>" href="/rekap-mukholif/pengaturan/">
