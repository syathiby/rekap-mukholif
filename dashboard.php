...
$can_view_top_pelanggar = has_permission('rekap_per_santri');  // Tombol "Lihat semua" Top Pelanggar
...
$teladan_href = $can_view_santri_teladan ? 'href="rekap/rekap_per_santri.php?tipe=santri_teladan"' : 'href="#"';
                        ...
                        <div class="tab-content" id="studentTabsContent">
                            <div class="tab-pane fade show active" id="violators-panel" role="tabpanel">
                                <?php if ($can_view_top_pelanggar): ?>
                                    <div class="text-end mb-3"><a href="rekap/rekap_per_santri.php?tipe=pelanggaran_umum" class="text-primary text-decoration-none small fw-medium">Lihat semua <i class="fas fa-arrow-right"></i></a></div>
                                <?php endif; ?>
                            ...
                            <div class="tab-pane fade" id="teladan-panel" role="tabpanel">
                                <?php if ($can_view_santri_teladan): ?>
                                    <div class="text-end mb-3"><a href="rekap/rekap_per_santri.php?tipe=santri_teladan" class="text-primary text-decoration-none small fw-medium">Lihat semua <i class="fas fa-arrow-right"></i></a></div>
                                <?php endif; ?>
