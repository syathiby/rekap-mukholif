...
<style>
    ...
    /* Warna Hijau Diniyyah di Select2 */
    ...
    .form-step-label .step-number {
        ...
        border-radius: 50%; 
        background-color: var(--bs-success); /* Hijau Diniyyah */
        ...
        <div class="card-header bg-success text-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="mb-0 fs-5 fs-md-4">
                    <i class="fas fa-book-quran me-2"></i> Input Diniyyah
                </h4>
                
                <?php if (has_permission('rekap_view_diniyyah')): ?>
                <a href="rekap.php" class="btn btn-light btn-sm d-flex align-items-center gap-2 text-success fw-bold">
            ...
            <form action="process.php" method="POST" id="form-pelanggaran">
                ...
                <div class="d-grid mt-4">
                    <button type="submit" name="create_bulk_pelanggaran" class="btn btn-success py-3 shadow-sm">
                        <i class="fas fa-save me-2"></i> Simpan Data Diniyyah
                    </button>
                </div>
            </form>
        </div>
...
$(document).ready(function() {
    ...
    function tambahSantri() {
        ...
        // LOGIC HTML BARIS TABEL (Sama kayak Bahasa)
        let barisBaru = `
