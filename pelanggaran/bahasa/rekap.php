...
// +++ DISISIPKAN DI SINI: Ambil periode aktif dari database +++
...
// --- DIUBAH DI SINI: Default tanggal awal sekarang diambil dari $periode_aktif ---
$start_date = $_GET['start_date'] ?? $periode_aktif; 
$end_date = $_GET['end_date'] ?? date('Y-m-d');


// =======================================================
// BAGIAN 2: QUERY UTAMA (MODEL PERINGKAT) - Tidak ada perubahan
// =======================================================
...
// =======================================================
// BAGIAN 3: PERSIAPAN DATA UNTUK GRAFIK (Dengan Revisi) - Tidak ada perubahan
// =======================================================
...
<!-- ======================================================= -->
<!-- BAGIAN 4: TAMPILAN HTML DENGAN GAYA BARU + GRAFIK - Tidak ada perubahan -->
<!-- ======================================================= -->
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Peringkat Pelanggaran Bahasa</title>
...
<div class="container py-4">
    <h1 class="page-title mb-4"><i class="fas fa-crown me-3"></i>Peringkat Pelanggaran Bahasa</h1>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr class="rank-<?= $no ?>">
                            ...
                            <td class="text-center">
                                <a href="detail-bahasa.php?santri_id=<?= $row['id'] ?>&start_date=<?= $start_date ?>&end_date=<?= $end_date ?>" class="btn btn-sm btn-detail rounded-pill px-3">
