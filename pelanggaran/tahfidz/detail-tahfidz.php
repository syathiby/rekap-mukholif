...
<div class="container py-4">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-start align-items-md-center mb-4">
        <a href="rekap.php?start_date=<?= $start_date ?>&end_date=<?= $end_date ?>" class="btn btn-outline-secondary mb-3 mb-md-0"><i class="fas fa-arrow-left me-2"></i>Kembali ke Rekap</a>
        
        <h1 class="page-title mb-0 w-100 w-md-auto text-center text-md-end h5">Detail Pelanggaran Tahfidz</h1>
    </div>
