...
<style>
    /* ✅ DEFINISI WARNA MERAH TAHFIDZ */
    :root {
        --bs-tahfidz-red: #D9534F; /* Merah soft */
        --bs-tahfidz-red-rgb: 217, 83, 79;
        --bs-tahfidz-red-dark: #C9302C;
    }
    ...
    /* Warna Focus Select2 Merah */
    .select2-container--bootstrap-5.select2-container--focus .select2-selection {
        border-color: var(--bs-tahfidz-red);
        box-shadow: 0 0 0 0.25rem rgba(var(--bs-tahfidz-red-rgb), 0.25);
    }
    ...
    .form-step-label .step-number {
        ...
        border-radius: 50%; 
        background-color: var(--bs-tahfidz-red); /* Merah Tahfidz */
        color: #fff; font-size: 1rem; font-weight: 700; margin-right: 0.75rem;
    }

    /* -- Custom Button Red -- */
    .btn-tahfidz-red {
        background-color: var(--bs-tahfidz-red);
        border-color: var(--bs-tahfidz-red);
        color: #fff;
        font-weight: 600;
        padding: 0.85rem; /* Padding gede buat tombol simpan */
        border-radius: 0.5rem;
    }
    .btn-tahfidz-red:hover {
        background-color: var(--bs-tahfidz-red-dark);
        border-color: var(--bs-tahfidz-red-dark);
        color: #fff;
    }
...
<div class="container my-4">
    <div class="card col-xl-10 col-lg-12 mx-auto shadow-sm">
        <!-- Header Merah Tahfidz -->
        <div class="card-header text-white" style="background-color: var(--bs-tahfidz-red);">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="mb-0 fs-5 fs-md-4">
                    <i class="fas fa-book-reader me-2"></i> Input Tahfidz
                </h4>
                
                <?php if (has_permission('rekap_view_tahfidz')): ?>
                <a href="rekap.php" class="btn btn-light btn-sm d-flex align-items-center gap-2" style="color: var(--bs-tahfidz-red); font-weight: bold;">
        ...
        <div class="card-body p-3 p-md-4">
            ...
            <form action="process.php" method="POST" id="form-pelanggaran">
                ...
                <div class="d-grid mt-4">
                    <!-- Tombol Simpan Merah -->
                    <button type="submit" name="create_bulk_pelanggaran" class="btn btn-tahfidz-red shadow-sm">
                        <i class="fas fa-save me-2"></i> Simpan Data Tahfidz
                    </button>
                </div>
            </form>
        </div>
