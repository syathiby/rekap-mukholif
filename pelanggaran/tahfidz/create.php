...
// =========================================================================
// ✅ Query Jenis Pelanggaran (KHUSUS TAHFIDZ)
// =========================================================================
$sql_query = "
...
<div class="container-fluid py-4 px-4">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
        <div>
            <h3 class="fw-bolder text-dark mb-1"><i class="fas fa-quran text-danger me-2"></i>Input Tahfidz</h3>
            <p class="text-muted mb-0">Catat pelanggaran bagian tahfidz untuk santri.</p>
        </div>
        <a href="rekap.php" class="btn-back shadow-sm text-decoration-none">
            <i class="fas fa-chart-line me-1"></i> Rekap Tahfidz
        </a>
    </div>
            ...
            <div class="col-lg-4 d-flex flex-column gap-4">
                ...
                <div class="pro-card">
                    <div class="pro-card-header d-flex align-items-center">
                        <div class="bg-danger bg-opacity-10 text-danger rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 36px; height: 36px;">
                ...
                <div class="pro-card h-100 d-flex flex-column">
                    ...
                    <div class="pro-card-footer mt-auto">
                        <button type="submit" name="create_bulk_pelanggaran" class="btn-save">
                            <i class="fas fa-check-circle me-2"></i> SIMPAN DATA TAHFIDZ
                        </button>
                    </div>
                </div>
            </div>
