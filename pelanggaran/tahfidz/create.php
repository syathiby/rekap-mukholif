...
// =========================================================================
// ✅ Query disederhanakan (WHERE Tahfidz)
// =========================================================================
$sql_query = "
...
<style>
    /* ✅ PERBAIKAN 1: Definisikan warna merah soft baru */
    :root {
        --bs-tahfidz-red: #D9534F; /* Merah klasik yg lebih soft */
        --bs-tahfidz-red-rgb: 217, 83, 79;
        --bs-tahfidz-red-dark: #C9302C; /* Untuk hover */
        --bs-tahfidz-red-darker: #C12E2A; /* Untuk hover border */
    }
    ...
    .select2-container--bootstrap-5.select2-container--focus .select2-selection {
        /* ✅ PERBAIKAN 1: Gunakan warna soft red */
    ...
    /* ✅ PERBAIKAN 1: Buat class tombol soft red baru */
    .btn-tahfidz-red {
        background-color: var(--bs-tahfidz-red);
        border-color: var(--bs-tahfidz-red);
        color: #fff;
    ...
    .btn-tahfidz-red:hover {
        ...
        border-color: var(--bs-tahfidz-red-darker);
        color: #fff;
    }

    /* -- Style Tombol "Tambah" Santri -- */
    .input-group .btn-tahfidz-red { /* ✅ PERBAIKAN 1: Ganti ke class baru */
    ...
    /* ✅ PERBAIKAN 2: Ganti style tombol simpan ke .btn-success */
    .btn-success { 
        font-size: 1.1rem;
        font-weight: 600;
        padding: 0.85rem;
    ...
    <div class="card col-xl-10 col-lg-12 mx-auto shadow-sm">
        <div class="card-header text-white" style="background-color: var(--bs-tahfidz-red);">
            <div class="d-none d-md-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    <i class="fas fa-book-reader me-2"></i> Catat Pelanggaran Tahfidz
                </h4>
            ...
            <form action="process.php" method="POST" id="form-pelanggaran">
                ...
                <div class="form-step">
                    ...
                    <div class="input-group">
                        ...
                        <button class="btn btn-tahfidz-red" type="button" id="btn-tambah-santri" disabled>
