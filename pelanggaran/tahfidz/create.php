...
$jenis_pelanggaran_list_result = mysqli_query($conn, "SELECT id, nama_pelanggaran, poin FROM jenis_pelanggaran WHERE bagian = 'Tahfidz' ORDER BY nama_pelanggaran ASC");
...
<div class="container my-4">
    <div class="card col-xl-10 col-lg-12 mx-auto shadow-sm">
        <!-- Header Responsif dengan Tema Tahfidz (Merah) -->
        <div class="card-header bg-danger text-white">
            ...
            <div class="d-md-none text-center"> <!-- ✅ tambahin text-center disini -->
                <h4 class="mb-2">
                    <i class="fas fa-language me-2"></i> Catat Pelanggaran Tahfidz
                </h4>
