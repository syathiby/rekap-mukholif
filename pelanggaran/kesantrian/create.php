...
<style>
    ...
    /* Poin Badge */
    .badge-poin { color: #ef4444; font-weight: 600; font-size: 0.85rem; background: #fef2f2; padding: 4px 8px; border-radius: 6px; }
...
<div class="container-fluid py-4 px-4">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
        <div>
            <h3 class="fw-bolder text-dark mb-1"><i class="fas fa-users-cog text-primary me-2"></i>Input Kesantrian</h3>
            <p class="text-muted mb-0">Catat pelanggaran bagian kesantrian untuk santri.</p>
        </div>
        <a href="rekap.php" class="btn-back shadow-sm text-decoration-none">
            <i class="fas fa-chart-line me-1"></i> Rekap Kesantrian
        </a>
    </div>
                            ...
                            <select name="jenis_pelanggaran_id" id="jenis_pelanggaran_id" class="form-select" required>
                                ...
                                if ($jenis_pelanggaran_result && $jenis_pelanggaran_result->num_rows > 0) {
                                    ...
                                    while ($jp = $jenis_pelanggaran_result->fetch_assoc()) {
                                        echo '<option value="' . $jp['id'] . '">' . htmlspecialchars($jp['nama_pelanggaran']) . ' (' . $jp['poin'] . ' Poin)</option>';
                                    }
                                }
                                ?>
                            </select>
            ...
            <div class="col-lg-8">
                <div class="pro-card h-100 d-flex flex-column">
                    ...
                    <div class="pro-card-footer mt-auto">
                        <button type="submit" name="simpan_pelanggaran_kesantrian" class="btn-save">
                            <i class="fas fa-check-circle me-2"></i> SIMPAN DATA PELANGGARAN
                        </button>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $("#form-pelanggaran").on('submit', function(e) {
        ...
        $.ajax({
            ...
            data: form.serialize() + '&simpan_pelanggaran_kesantrian=1', 
            dataType: 'json',
