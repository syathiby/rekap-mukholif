...
<head>
    ...
    <title>Form Pelanggaran Telat Sholat</title>
...
<div class="container animate__animated animate__fadeIn">
    ...
    <form action="process.php" method="POST">
        <div class="table-responsive">
            <table class="table table-bordered table-hover animate__animated animate__slideInUp">
                ...
                <tbody>
                    ...
                    <?php if (!$adaData): ?>
                        <tr class="no-data">
                            <td colspan="4" class="text-center py-4" style="color: var(--accent-color);">
                                <i class="far fa-smile-beam fa-2x mb-2"></i><br>Tidak ada pelanggaran yang bisa dieksekusi.
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
        ...
        <!-- Tombol submit diletakkan di luar table -->
